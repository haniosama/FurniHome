    ...
    <nav className="sticky top-0 left-0 w-full bg-[#0058ab] text-white z-50 shadow-lg">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <div className="hidden md:flex items-center space-x-4 justify-center">
          ...
          <Link to="/register" className="hover:text-gray-300 border-r-2 border-gray-300 px-2 text-sm lg:text-base">
            Register
          </Link>
          <Link to="/login" className="hover:text-gray-300 text-sm lg:text-base">
            Login
          </Link>
