...
const SideSliderDashboard = () => {
    ...
    return (
        <div className={`${openSlider?"translate-x-0":"-translate-x-[210px]"} lg:translate-x-0 h-[90vh] bg-white p-2 pt-5 fixed top-[65px] w-[210px] text-gray-700 transition-all duration-500 z-10`}>
            ...
            <NavLink onClick={()=>setOpenSlider(false)} to="products" className="flex items-center justify-start gap-2  w-[180px] mx-auto rounded-2xl mt-2 cursor-pointer py-3 pl-3 pr-10 transition-all duration-300 hover:translate-x-2 hover:text-[#3d5f9e] hover:bg-[#3d5f9e1a]">
