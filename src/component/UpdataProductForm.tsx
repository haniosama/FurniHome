  ...
  return (
    <motion.form 
            ...
            >
                ...
                <h2 className="text-center text-2xl font-medium text-sky-700 mb-10">Upadata Product</h2>
                <button title="close" onClick={()=>setOpenUpdataProductContainer(false)} className="absolute top-5 right-5 text-3xl font-medium text-red-700 transition-all duration-500 hover:rotate-180 cursor-pointer"><IoMdClose/> </button>
                ...
                <input type="submit" value={'Updata'} className="bg-sky-700 cursor-pointer mt-10 text-white w-[90%] mx-auto block py-2 rounded-xl border-2 border-sky-700 transition-all duration-300 hover:bg-white hover:text-sky-700" />
            </motion.form>
  )
}

export default UpdataProductForm
