...
// ================ manager =============
export const getProdectForManager = createAsyncThunk(
  "dashboard/getProdectForManager",
  async () => {
    try {
      const data = await (
...
export const getOrdersForManager = createAsyncThunk(
  "dashboard/getOrdersForManager",
  async () => {
    try {
      const data = await (
...
export const getcategoryForManager = createAsyncThunk(
  "dashboard/getcategoryForManager",
  async () => {
    try {
      const data = await (
...
export const getCustomerForManager = createAsyncThunk(
  "dashboard/getCustomerForManager",
  async () => {
    try {
      const data = await (
        await fetch(`${baseUrl}/api/customer`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
...
export const getCouponsForManager = createAsyncThunk(
  "dashboard/getCouponsForManager",
  async () => {
    try {
      const data = await (
        await fetch(`${baseUrl}/api/coupon/manager`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
...
export const deleteOrderForUser = createAsyncThunk(
  ...
  async (orderId: string) => {
    try {
      const data = await (
        await fetch(`${baseUrl}/api/order/delete/${orderId}`, {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const getcategoryForAdmin = createAsyncThunk(
  "dashboard/getCategies",
  async () => {
    try {
      const data = await (
        await fetch(`${baseUrl}/api/categoriesForAdmin`, {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const deleteCategoryForAdmin = createAsyncThunk(
  "dashboard/deleteCategoryForAdmin",
  async (categoryName: string) => {
    try {
      const data = await (
        await fetch(`${baseUrl}/api/categories/${categoryName}`, {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const getCouponsForAdmin = createAsyncThunk(
  "dashboard/getCouponsForAdmin",
  async () => {
    try {
      const data = await (
        await fetch(`${baseUrl}/api/coupon`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
...
export const deleteAdminCoupon = createAsyncThunk(
  ...
  async (couponId: string) => {
    try {
      const data = await (
        await fetch(`${baseUrl}/api/coupon/${couponId}`, {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const changeStatus = createAsyncThunk(
  ...
  async ({
    ...
    try {
      const data = await (
        await fetch(`${baseUrl}/api/order/status/${orderId}`, {
          method: "POST",
          headers: {
...
const dashboardAdmim = createSlice({
  ...
  extraReducers: (builder) => {
    // ========== Manager ===============
    builder.addCase(getProdectForManager.fulfilled, (state, action) => {
      state.products = action.payload;
      state.isLoading = false;
    });
    builder.addCase(getProdectForManager.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(getProdectForManager.rejected, (state, action) => {
      state.error = action.payload as string;
      state.isLoading = false;
    });

    builder.addCase(getOrdersForManager.fulfilled, (state, action) => {
      state.orders = action.payload;
      state.isLoading = false;
    });
    builder.addCase(getOrdersForManager.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(getOrdersForManager.rejected, (state, action) => {
      state.error = action.payload as string;
      state.isLoading = false;
    });

    builder.addCase(getcategoryForManager.fulfilled, (state, action) => {
      state.categories = action.payload;
      state.isLoading = false;
    });
    builder.addCase(getcategoryForManager.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(getcategoryForManager.rejected, (state, action) => {
      state.error = action.payload as string;
      state.isLoading = false;
    });

    builder.addCase(getCustomerForManager.fulfilled, (state, action) => {
      state.customers = action.payload;
      state.isLoading = false;
    });
    builder.addCase(getCustomerForManager.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(getCustomerForManager.rejected, (state, action) => {
      state.error = action.payload as string;
      state.isLoading = false;
    });

    builder.addCase(getCouponsForManager.fulfilled, (state, action) => {
      state.coupons = action.payload;
      state.isLoading = false;
    });
    builder.addCase(getCouponsForManager.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(getCouponsForManager.rejected, (state, action) => {
      state.error = action.payload as string;
      state.isLoading = false;
    });
    ...
    builder.addCase(deleteOrderForUser.fulfilled, (state, action) => {
      state.orders = action.payload;
      state.isLoading = false;
    });
    builder.addCase(deleteOrderForUser.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(deleteOrderForUser.rejected, (state, action) => {
      state.error = action.payload as string;
      state.isLoading = false;
    });

    builder.addCase(getcategoryForAdmin.fulfilled, (state, action) => {
      state.categories = action.payload;
      state.isLoading = false;
    });
    builder.addCase(getcategoryForAdmin.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(getcategoryForAdmin.rejected, (state, action) => {
      state.error = action.payload as string;
      state.isLoading = false;
    });

    builder.addCase(deleteCategoryForAdmin.fulfilled, (state, action) => {
      state.categories = action.payload.data;
      state.isLoading = false;
    });
    builder.addCase(deleteCategoryForAdmin.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(deleteCategoryForAdmin.rejected, (state, action) => {
      state.error = action.payload as string;
      state.isLoading = false;
    });

    builder.addCase(getCouponsForAdmin.fulfilled, (state, action) => {
      state.coupons = action.payload;
      state.isLoading = false;
    });
    builder.addCase(getCouponsForAdmin.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(getCouponsForAdmin.rejected, (state, action) => {
      state.error = action.payload as string;
      state.isLoading = false;
    });

    builder.addCase(deleteAdminCoupon.fulfilled, (state, action) => {
      state.coupons = action.payload;
      state.isLoading = false;
    });
    ...
    builder.addCase(updataProduct.fulfilled, (state, action) => {
      state.products = action.payload;
      state.isLoading = false;
    });
    builder.addCase(updataProduct.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(updataProduct.rejected, (state, action) => {
      state.error = action.payload as string;
      state.isLoading = false;
    });
